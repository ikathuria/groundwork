...
type: reagent
slug: LPS
aliases: [lipopolysaccharide, endotoxin]
cas: variable
suppliers:
  - name: Sigma-Aldrich
    catalog: "L2630 (E. coli O111:B4)"
    notes: "the canonical TLR4 agonist in mouse barrier studies"
  - name: Sigma-Aldrich
    catalog: "L4391 (E. coli O55:B5)"
storage: "−20 °C, lyophilised; reconstituted aliquots single-use"
hazards: pyrogen — handle with care; do not use in cell-culture areas without dedicated tools
known_failure_modes: [LPS-contamination-bacterial-prep]
related_methods: [LPS-endotoxin-quantification, FITC-dextran-permeability-assay]
created: 2026-04-25
updated: 2026-04-25
tags: [endotoxin, TLR4-agonist, challenge-reagent, translocation-marker]
---

# Lipopolysaccharide (LPS / endotoxin)

Two distinct uses in this corpus:

1. **Challenge reagent**: i.p. or oral LPS to acutely break the gut barrier in mouse models, demonstrating that the assay can detect a positive change.
2. **Translocation marker**: plasma LPS (LAL) or LBP (ELISA) as a systemic readout of barrier failure — orthogonal to FD-4. See [[../methods/LPS-endotoxin-quantification]].

A third role is nuisance: residual LPS from gram-negative contamination of LGG cultures can drive a cytokine response wrongly attributed to LGG itself. See [[../failure-modes/LPS-contamination-bacterial-prep]].
